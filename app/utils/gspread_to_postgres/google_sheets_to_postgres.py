...
def execute(max_worker=5):
    ...
    from app.utils.gspread_to_postgres.settings import Spreadsheet_config as sp_config
    from app.utils.gspread_to_postgres.settings import PostgresSQL_config as psql_config
    ...
    main_sheet = GoogleSheetHelper(
        sp_config.credential_path, sp_config.spreadsheet_name)
